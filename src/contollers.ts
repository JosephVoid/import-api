...
export const CreateTableController = (req, res) => {
  ...
  connection.execute('CREATE TABLE '+connection.escapeId(table_name)+' (id INT AUTO_INCREMENT, PRIMARY KEY (id), item_no VARCHAR(20), item_desc VARCHAR(200), item_qty VARCHAR(20), item_price VARCHAR(20), item_rate VARCHAR(20), item_unit VARCHAR(20))', (error) => {
